...
int main(int argc, char *argv[]){
	char ch,ch1;
	FILE *fp;
	int i = 0,j = 0,start_i,start_j,M,N,end_i,end_j,d;
	...
	fclose(fp);
	N = i;	
																												/*xwris \n sto telos tou text file*/
/*.....................................................................	
	i = j = 0;
	while(i <= N){
		while(j <= M){
			printf("(%c,%d,%d)",space[i][j].box,space[i][j].distance1,space[i][j].distance2);
			j++;
		}
		printf("\n");
		j = 0;
...
.....................................................................*/	
	...
	while(head!=NULL){
		while(head != (tail -> next)){	
			if(((head -> i) - 1) >= 0 && ((head -> i) - 1) <= N){															/*check upper box if that exists*/
				...
				if(newbox == true){
					...
					/*.....................................................................*/
					//printf("(%d,%d)\n",current -> i,current -> j);
					//printf("%d\n",space[current -> i][current -> j].distance1);
					//printf("%d\n",space[current -> i][current -> j].distance2);
				}
			}
		...
		/*.....................................................................*/
		//printf("neo group geitwnwn\n");			
		current1 -> next = NULL;			
		free(current1);					
		tail = current;
	}
	printf("%d\n",space[end_i][end_j].distance1);
