...
import exercise3_2018_2019_8110111.*;

public class RegisterController_ex3_8110111 extends HttpServlet {
     ...
     public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher footer = request.getRequestDispatcher("/footer_ex3_8110111.jsp");
         ...
         try {
			...
			out.println("						<li><a href='../index_ex3_8110111.jsp'>Home</a></li>					");
			out.println("						<li><a href='../about_ex3_8110111.jsp'>About</a></li>					");
			out.println("					</ul>");
			out.println("					<ul class='nav navbar-nav navbar-right'>");
			out.println("						<li class='active'><a href='../register_ex3_8110111.jsp'>Register</a></li>");
			out.println("			        	<li><a href='../login_ex3_8110111.jsp'>Sign in</a></li>			            ");
			out.println("			        </ul>					");
			out.println("				</div>");
			out.println("			</div>");
			out.println("		</nav>");
			...
			out.println("				<h1>3rd Personal Exercise</h1>");
			out.println("			</div>");
            ...
            else if (!(name.length() >= 3) || !(surname.length() >= 3) || !(username.length() >= 5) || !(password.length() >= 5) || !(password.equals(confirm)) || user != null)
			{
              out.println("<div class='page-header'>");
			  ...
			  if(user != null){
				out.println("<li>Username " + username + " already exists</li>");
			  }
              ...
              out.println("<p style='text-align: center;'><a href='../register_ex3_8110111.jsp' class='btn btn-info' role='button'><span class='glyphicon glyphicon-chevron-left'></span> Back to the form</a></p>");
			  out.println("</button>");
			  out.println("</div>");
      ...
      public void doGet(HttpServletRequest request, HttpServletResponse response)
        throws IOException, ServletException {
            response.sendRedirect("../register_ex3_8110111.jsp");
      	}
}
