...
<%
RequestDispatcher rderror1 = request.getRequestDispatcher("/login_ex3_8110111.jsp");
...
<html lang="en">
	<head>
		...
		<meta name="description" content="3η Ατομική Άσκηση 2018-2019 - Dashboard">
			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="dashboard_ex3_8110111.jsp">Dashboard</a></li>					
					</ul>
					<ul class="nav navbar-nav navbar-right">
						<li><p class="navbar-text">Signed in as <%=user.getUsername() %></p></li>
			        	<li><a href="logout_ex3_8110111.jsp"><span class="glyphicon glyphicon-log-out"></span> Sign out</a></li>			            
			        </ul>		
