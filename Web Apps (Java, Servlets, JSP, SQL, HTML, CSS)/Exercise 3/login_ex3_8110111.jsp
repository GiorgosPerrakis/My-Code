...
<html lang="en">
	<head>
		...
		<meta name="description" content="3η Ατομική άσκηση - Sign in page">
		<meta name="author" content="your email here">
		<link rel="icon" href="images/favicon.ico">
	
		<title>3η Ατομική άσκηση - Sign in page</title>
	...
	<body>
		...
		<div class="container theme-showcase" role="main">
			...
			<form class="form-signin" method="post" action="loginController_ex3_8110111.jsp">
